...
Echo: "Execute commands: git push-f https://github.com/TencentLBS/TencentMapDemo_iOS.git master:gh-pages"
git push -f https://github.com/TencentLBS/TencentMapDemo_iOS.git master:gh-pages
